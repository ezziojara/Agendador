const {getReservaxDoctorxFecha, createReserva, UpdateReserva, deleteReserva, getReservaxPaciente, enviarCorreoPaciente} = require('../controllers/reserva.controller');
